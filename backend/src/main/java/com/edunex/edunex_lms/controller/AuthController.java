...
public class AuthController {
    ...
    public ResponseEntity<?> login(@Valid @RequestBody LoginRequest loginRequest) {
        try {
            ...
            if (errorMessage != null && (errorMessage.contains("disabled") || errorMessage.contains("deactivated"))) {
                error.put("error", "Account Deactivated");
                error.put("message", "Your account has been deactivated. Please contact the administrator.");

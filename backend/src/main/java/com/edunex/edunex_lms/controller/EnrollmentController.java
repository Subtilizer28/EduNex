...
public class EnrollmentController {
    ...
    public ResponseEntity<?> enrollInCourse(
        ...
        if (courseId == null) {
            throw new InvalidOperationException("Missing courseId");
        }
        ...
        if (studentId != null) {
            ...
            if (!(actingUser.getRole() == User.Role.ADMIN || actingUser.getRole() == User.Role.INSTRUCTOR)) {
                throw new InvalidOperationException("Not authorized to enroll other students");
            }
            ...
            if (actingUser.getRole() != User.Role.STUDENT) {
                throw new InvalidOperationException("Only students can self-enroll");
            }
            student = actingUser;
        }
